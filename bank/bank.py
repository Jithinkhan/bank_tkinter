...
class ritu(Frame):
    ...
    def create_widgets(self):
        self.label=Label(self,text="Punjab National Bank",font="Times 60 bold",fg="blue").grid(row=0,column=1,columnspan=1)
        self.label2=Label(self,text="Address-Kachhari More,Rajpur",font="Times 20 bold",fg="black").grid(row=2,column=0,columnspan=7)
        self.label3=Label(self,text="Dist-Rohtas  State-Bihar",font="Times 20 bold",fg="black").grid(row=3,column=0,columnspan=3)
        self.label4=Label(self,text="PinCode-802219",font="Times 20 bold",fg="black").grid(row=4,column=0,columnspan=4)
        self.label5=Label(self,text="Contact here...",font="Times 20 bold",fg="black").grid(row=2,column=6,columnspan=3)
        self.label6=Label(self,text="Mob-09955418205",font="Times 20 bold",fg="red").grid(row=3,column=6,columnspan=3)
        ...
        #self.photo=PhotoImage(file="ritu5.gif")
        #self.label=Label(self,image=self.photo).grid(row=0)
    ...
    def remove(self):
        class pusa(Frame):
            def __init__(self,master):
                ...
                ## delete account
                self.label=Label(self,text="Delete Account..",font="Times 35 bold",fg="blue").grid(row=11,column=0)
                self.label=Label(self,text="Enter Nominee Id",font="Times 20 bold",fg="green").grid(row=12,column=0)

                self.entry4=Entry(self,width=20,font="Times 20 bold",fg="purple")
                self.entry4.grid(row=12,column=1)
            ...
            def transfer(self):
                ...
                ##self.label3=Label(self,text="Amount transferred by id-%s to id-%s is %s"%(content,content5,content4),font="Times 20 bold",fg="red").grid(row=13,co)
    ...
    def press(self):
        class golu(Frame):
            ...
            def create_widgets(self):
                self.label=Label(self,text="Punjab National Bank",font="Times 60 bold",fg="blue").grid(row=0,column=1,columnspan=1)
                self.label2=Label(self,text="Address-Kachhari More,Rajpur",font="Times 20 bold",fg="black").grid(row=2,column=0,columnspan=5)
                self.label3=Label(self,text="Dist-Rohtas  State-Bihar",font="Times 20 bold",fg="black").grid(row=3,column=0,columnspan=3)
                self.label4=Label(self,text="PinCode-802219",font="Times 20 bold",fg="black").grid(row=4,column=0,columnspan=4)
                self.label5=Label(self,text="Contact here...",font="Times 20 bold",fg="black").grid(row=2,column=4,columnspan=3)
                self.label6=Label(self,text="Mob-09955418205",font="Times 20 bold",fg="red").grid(row=3,column=4,columnspan=3)
